      ...
      <div class="navbar navbar-expand-lg fixed-top navbar-dark bg-primary">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav"> 
            ...
            <li class="nav-item">
              <router-link class="nav-link" to="/vendedores">Vendedor</router-link>
            </li>
            <li class="nav-item">
              <router-link class="nav-link" to="/veiculos">Veiculo</router-link>
            </li>
            <li class="nav-item">
              <router-link class="nav-link" to="/tipos">Tipo</router-link>
            </li>
            <li class="nav-item">
              <router-link class="nav-link" to="/compradores">Comprador</router-link>
            </li>
            <li class="nav-item">
              <router-link class="nav-link" to="/vendas">Venda</router-link>
            </li>
            <li class="nav-item">            
